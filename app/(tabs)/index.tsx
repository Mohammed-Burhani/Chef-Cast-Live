...
const styles = StyleSheet.create({
  ...
  username: { fontSize: 24, fontWeight: "800", letterSpacing: -0.5, fontFamily: 'PlayfairDisplay_800ExtraBold' },
  ...
  sectionTitle: { fontSize: 18, fontWeight: "700", fontFamily: 'PlayfairDisplay_700Bold' },
  ...
  liveBannerTitle: { fontSize: 13, fontWeight: "700", letterSpacing: 0.5, fontFamily: 'PlayfairDisplay_700Bold' },
  ...
  episodeTitle: { fontSize: 15, fontWeight: "700", lineHeight: 20, fontFamily: 'PlayfairDisplay_600SemiBold' },
